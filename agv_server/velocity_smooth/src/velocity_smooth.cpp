...
{
public:
    Jrc_move():w_max_(0.7),beta_max_(0.2),vx_max_(0.7),ax_max_(0.2),vy_max_(0.7),ay_max_(0.2),initial_x_(-1.181),initial_y_(-0.060),initial_angle_(-0.01)
    {
      ...
      arrive_mark = false;
        ...
        //Server
        service = node.advertiseService("agv_move", &Jrc_move::move_to_target, this);  //Jrc_move_multi
        //initial the goal
