...
public:
    Jrc_move()
    {
        ...
        //Server
        service = node.advertiseService("agv_move", &Jrc_move::move_to_target, this);
        //initial the goal
        ...
        initial_pose.pose.pose.position.x = -0.964;
        initial_pose.pose.pose.position.y = -0.069;
       /* double q1,q2,q3,q4,yaw;
        ...
        yaw=arctan
*/
        initial_pose.pose.pose.orientation = tf::createQuaternionMsgFromYaw(-1.526);
