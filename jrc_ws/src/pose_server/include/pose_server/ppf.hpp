...
public:
    ...
    void setParameters(const double distSampling, const double angleStep,
                  const double rotationThred, const double positionThred);
    void preProcessing(CloudPointT1Ptr pc, CloudPointT2 &pc_with_normals, CloudPointT1 &pc_show, bool training);
