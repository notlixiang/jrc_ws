...
int twist_service(ros::ServiceClient twist_client, int object_label, int angle)
{
    ...
    if((object_label == 2) || (object_label == 5) || (object_label == 6) || (object_label == 13) || (object_label == 14))
        angle = 70;
    else if((object_label == 1) || (object_label == 3) || (object_label == 4) || (object_label == 7) || (object_label == 8) || (object_label == 9) ||
...
int main(int argc, char** argv) 
{
    ...
    agv_service(agv_client,point[1]);
    sleep(1);
    agv_service(agv_client,point[2]);
    sleep(1);
    while(1)
    {   
    ...
    ur_10_service_move(ur10_client,3,1);
    twist_service(twist_client,-1,50);
    agv_service(agv_client,point[3]);
    sleep(1);
    agv_service(agv_client,point[4]);
    sleep(1);
