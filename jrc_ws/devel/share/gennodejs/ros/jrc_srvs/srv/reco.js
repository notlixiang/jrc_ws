...
class recoRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type recoRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type recoRequest
    let len;
    let data = new recoRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new recoRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class recoResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type recoResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type recoResponse
    let len;
    let data = new recoResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new recoResponse(null);
