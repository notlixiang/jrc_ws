...
"""autogenerated by genpy from jrc_srvs/rgbdRequest.msg. Do not edit."""
import sys
...
class rgbdRequest(genpy.Message):
  _md5sum = "676aa7bfb3ec2071e814f2368dfd5fb5"
  _type = "jrc_srvs/rgbdRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rgbdRequest, self).__init__(*args, **kwds)
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from jrc_srvs/rgbdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class rgbdResponse(genpy.Message):
  _md5sum = "33cb5836216cc2f10faa186b171cbfdc"
  _type = "jrc_srvs/rgbdResponse"
  _has_header = False #flag to mark the presence of a Header object
...
string frame_id
"""
  __slots__ = ['rgb_image','depth_image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rgbdResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.rgb_image.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.rgb_image.encoding = str[start:end].decode('utf-8')
      else:
...
class rgbd(object):
  _type          = 'jrc_srvs/rgbd'
  _md5sum = '4eef606dcba8e10e7c0e4a74324986c4'
  _request_class  = rgbdRequest
  _response_class = rgbdResponse
