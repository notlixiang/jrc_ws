#ifndef OMPL_GEOMETRIC_PLANNERS_DESKR_PRM_
#define OMPL_GEOMETRIC_PLANNERS_DESKR_PRM_
...
namespace ompl
{
    namespace geometric
    {
        class DESKRPRM : public base::Planner
        {
        public:
            /** \brief Constructor */
            DESKRPRM(const base::SpaceInformationPtr &si);
