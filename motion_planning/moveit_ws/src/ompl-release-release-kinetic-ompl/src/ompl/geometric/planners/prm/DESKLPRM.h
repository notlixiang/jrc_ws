#ifndef OMPL_GEOMETRIC_PLANNERS_DESKL_PRM_
#define OMPL_GEOMETRIC_PLANNERS_DESKL_PRM_
...
namespace ompl
{
    namespace geometric
    {
        class DESKLPRM : public base::Planner
        {
        public:
            /** \brief Constructor */
            DESKLPRM(const base::SpaceInformationPtr &si);
